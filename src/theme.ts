  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedPrimary: {
          backgroundColor: "#d89cae",
          color: "#1a1718",
          border: "1px solid transparent",
          "&:hover": {
            backgroundColor: "#c98a9e",
          },
        },
        containedSecondary: {
          backgroundColor: "#b7a4c6",
          color: "#1a1718",
          border: "1px solid transparent",
          "&:hover": {
            backgroundColor: "#a592b8",
          },
        },
      },
    },
